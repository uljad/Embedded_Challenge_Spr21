...
rdfile_btn.grid(row=2, column=0, pady=pad_y, padx=pad_x)
setfile_btn.grid(row=3, column=0, pady=pad_y, padx=pad_x)
disp_btn.grid(row=4, column=0, pady=pad_y, padx=pad_x)
