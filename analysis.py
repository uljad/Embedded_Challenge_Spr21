...
def threading_():
    """ Threading Module
            ...
            This module sets up the function compute_slope on a seperate thread.
            This allows the portion of code getting data from the serial port to 
            continue without waiting for the function to return.
